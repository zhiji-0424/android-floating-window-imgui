...
- 仓库链接：[在gitee的](https://gitee.com/zhiji-0424/android-floating-window-imgui)、[在github的](https://github.com/zhiji-0424/android-floating-window-imgui)
- ~~因设备开发效率低，暂停开发，~~ *欢迎协助，幸甚至哉*
- 有新方案了，继续开发，欢迎加入开发
